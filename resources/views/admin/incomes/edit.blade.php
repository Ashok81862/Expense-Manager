...
<div class="card">
    <div class="card-header border-bottom-0">
        <h3 class="card-title text-bold" style="font-size:1.4rem">Update Income</h3>
    ...
    <div class="card-body">
        <form action="{{ route('admin.incomes.update', $income->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                >
                    @foreach($incomeCategories as $category)
                        <option value="{{ $category->id }}" @if($income->income_category_id == $category->id) selected @endif>{{ $category->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="mt-4 mb-1">
                <input type="submit" class="btn btn-primary" value="Update income">
