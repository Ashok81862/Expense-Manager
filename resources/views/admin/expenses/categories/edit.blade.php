...
<div class="card">
    <div class="card-header border-bottom-0">
        <h3 class="card-title text-bold" style="font-size:1.4rem">Update Expense Category</h3>
    ...
    <div class="card-body">
        <form action="{{ route('admin.expenseCategories.update', $expenseCategory->id) }}" method="POST">
            @csrf @method('PUT')
