...
<div class="card">
    <div class="card-header border-bottom-0">
        ...
        <div class="card-tools">
            <a href="{{ route('admin.expenseCategories.create') }}" class="btn btn-sm btn-info">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Delete Form -->
                        <form id="delete-form-{{ $categorie->id }}" action="{{ route('admin.expenseCategories.destroy', $categorie->id) }}" method="post">
                            @csrf @method('DELETE')
                        </form>
                    </td>
                </tr>
